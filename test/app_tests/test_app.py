...
class TestAppClass(unittest.TestCase):
	...
	def test_threads_int_parameter(self):
		app = App()
		app.threads(4)
		self.assertEqual(app.max_threads, 4)

	def test_threads_str_parameter(self):
		app = App()
		app.threads("4")
		self.assertEqual(app.max_threads, 4)

	def test_threads_invalid_parameter(self):
		app = App()
		app.threads("hello")
		self.assertEqual(app.max_threads, 1)

	def test_threads_negative_parameter(self):
		app = App()
		app.threads("-2")
		self.assertEqual(app.max_threads, 1)
